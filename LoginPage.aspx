        ...
        <div id="wrapper">
            <div class="contant">
                <h2> Register</h2>
                    ...
                    <input id="userbox" runat="server" type="text" placeholder="Enter Username" name="usr" required />
                    <label>Email</label>
                    <input id="emailbox" runat="server" type="email" placeholder="Enter Email" name="eml" required />
                    <label>Confirm</label>
                    <input type="email" runat="server" placeholder="Confirm Email" name="ceml" required />
                    <label>Password</label>
                    <input id="passwordbox" type="password" runat="server" placeholder="Enter Password" name="psw" required />
                    <label>Confirm</label>
                    <input type="password"  runat="server" placeholder="Confirm Password" name="cpsw" required />
                ...
                <hr />
                    ...
                    <label>Password</label>
                    <input runat="server" id="loginpasswordbox" type="password" placeholder="Enter Password" name="psw"  required />
